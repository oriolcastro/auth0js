 ...
 */
type CamelCasedProperties<INPUT> = INPUT extends Function ? INPUT : INPUT extends (infer U)[] ? CamelCasedProperties<U>[] : INPUT extends Set<infer U> ? Set<CamelCasedProperties<U>> : {
